...
export function ProjectCard({ title, desc, darkColor, lightColor, href }: ProjectCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-white/85 dark:text-gray-100 mb-4 text-xs leading-relaxed line-clamp-2">{desc}</p>
