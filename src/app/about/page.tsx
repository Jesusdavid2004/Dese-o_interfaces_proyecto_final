          ...
          <div className="relative px-8 md:px-12 py-10 md:py-12 bg-white/85 dark:bg-black/40 backdrop-blur-sm">
            ...
            <div className="text-center">
              <h1 className="text-2xl md:text-4xl font-extrabold text-gray-900 dark:text-white">
                ...
                Hola soy Jesus David Villota Arteaga
              </h1>
              <div className="mt-1 text-xl font-bold text-gray-800 dark:text-gray-100">1</div>
              <p className="mt-1 text-base md:text-lg text-gray-700 dark:text-gray-200">
                Soy desarrollador creativo
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
              ...
              <div className="md:col-span-4 flex justify-center">
                <div className="w-[250px] h-[250px] md:w-[280px] md:h-[280px] rounded-full overflow-hidden shadow-lg border-4 border-white/70 dark:border-gray-700">
                  <Image
                    src="/images/me.jpg"
                    alt="Jesus David Villota Arteaga"
                    width={280}
                    height={280}
              ...
              <div className="md:col-span-8">
                ...
                <p className="text-sm md:text-base leading-relaxed text-gray-800 dark:text-gray-200">
                  Soy estudiante de Ingeniería de Software y apasionado por el diseño de interfaces y el
                  desarrollo de aplicaciones. Me gusta combinar la creatividad con la tecnología para crear
                  experiencias digitales fáciles de usar, atractivas y funcionales. Tengo habilidades en
                  diseño de interfaces con Figma, programación en Angular, React y Python, además de
                  conocimientos en bases de datos y pruebas de software. Me considero una persona curiosa,
                  autodidacta y con muchas ganas de aprender y aportar en proyectos innovadores.
                </p>

                {/* 🧩 Tarjetas de Skills y Educación */}
