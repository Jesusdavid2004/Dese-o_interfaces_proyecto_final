...
function SocialRow({ lang }: { lang: Lang }) {
  return (
    <div className="mt-6 flex items-center justify-center gap-5">
      <IconCrystal
        label={t(lang, "github")}
        href="https://github.com/Jesusdavid2004"
        Icon={Github}
      />
      <IconCrystal
        label={t(lang, "linkedin")}
        href="https://www.linkedin.com/in/jes%C3%BAs-david-villota-arteaga-968335396/"
        Icon={Linkedin}
      />
      <IconCrystal
        label={t(lang, "mail")}
        href="mailto:jesus.villotaa@campus.ucc.edu.co"
        Icon={Mail}
      />
    </div>
  );
